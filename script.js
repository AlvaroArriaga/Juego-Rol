...
const weapons = [
  ...
  { name: 'Sable Laser', power: 150},
  { name: 'Zenith', power: 500}
];
const monsters = [
  {
    name: "Arbol Maldito",
...
const locations = [
  {
    ...
    fondo: 'url(Imagenes-Rol/Aldea-Medi.png)',
  },
  {
    name: "store",
    ...
    fondo: 'url(Imagenes-Rol/Tienda-Medi.png)',
  },
  {
    name: "cave",
    "button text": ["Pelear con la Arbol Maldito", "Pelear con el Skeleto", "Volver a la plaza del pueblo"],
    "button functions": [fightSlime, fightBeast, goTown],
    text: "Entras a la cueva y ves algunos monstruos.",
    fondo: 'url(Imagenes-Rol/Cueva.png)',
  },
  {
    name: "fight",
...
function fightSlime() {
  fondo.style.backgroundImage = 'url(Imagenes-Rol/Arbol.png)';
  fighting = 0;
  goFight();
}

function fightBeast() {
  fondo.style.backgroundImage = 'url(Imagenes-Rol/Skeleto.png)';
  fighting = 1;
  goFight();
}

function fightDragon() {
  fondo.style.backgroundImage = 'url(Imagenes-Rol/Dragon.png)';
  fighting = 2;
  goFight();
}
